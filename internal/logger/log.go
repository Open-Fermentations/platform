...
func resolveLogLevel(level env.LogLevel) (logLevel int) {
	switch level {
	case env.LogLevelEnum.Debug:
		logLevel = debugLevel
	case env.LogLevelEnum.Info:
		logLevel = infoLevel
	case env.LogLevelEnum.Warning:
		logLevel = warnLevel
	case env.LogLevelEnum.Error:
		logLevel = errorLevel
	case env.LogLevelEnum.None:
		logLevel = noneLevel
	default:
		logLevel = debugLevel
	}
